...
@Component
public class ChangeGroupFilter extends ZuulFilter {
    @Override
    ...
    public boolean shouldFilter() {
        ...
        //判断需要拦截的接口路径
        if("/group/changeGroup".equalsIgnoreCase(request.getRequestURI())){
            //true执行拦截器run方法
            return true;
        }
        return false;
    ...
    public Object run() throws ZuulException {
        ...
        if (StringUtils.isBlank(token) || !token.equals("6708")){
            //是否继续往下走 设置为false

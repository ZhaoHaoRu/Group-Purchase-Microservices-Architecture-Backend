package com.groupbuy.config.interceptor;

import com.groupbuy.utils.messageUtils.Message;
import com.groupbuy.utils.messageUtils.MessageUtil;
import com.groupbuy.utils.sessionUtils.SessionUtil;
...
public class SessionValidateInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object obj) throws Exception {
        ...
        if (userId == null) {
            Message message = MessageUtil.createMessage(MessageUtil.NOT_LOGIN_CODE, MessageUtil.NOTLOGGEDIN);
